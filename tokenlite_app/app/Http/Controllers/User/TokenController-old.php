...
class TokenController extends Controller
{
    ...
    public function generateOrder(Request $request)
    {
        ...
        $actual_tokens = $total_tokens - $total_bonus;
        $token_price = $request->token_price;

        $url = 'http://localhost:8081/tokenlite/public/user/contribute/payments';
        ...
        CURLOPT_HTTPHEADER => array(
            'x-api-key: CFZX79R-FEJMJY8-HBB6429-BQB11BB',
