...
// get ZohoCRM Refresh
Route::get('/getRefreshToken', 'Auth\RegisterController@getRefreshToken')->name('generate-refresh-token');
Route::get('/getAccessToken', 'Auth\RegisterController@getAccessToken')->name('getAccessToken');
Route::get('/insertZohoRecord', 'Auth\RegisterController@insertZohoRecord')->name('insertZohoRecord');
...
Route::prefix('user')->middleware(['auth', 'user', 'g2fa'])->name('user.')->group(function () {
    ...
    //Custom change tah
    Route::post('/contribute/payments', 'User\TokenController@generateOrder')->name('payments');
    Route::get('/order/details/{tnx_id}', 'User\TokenController@orderDetails')->name('order');
...
Route::get('/get-price-crypto/{usd}/{cryp}', 'User\TokenController@getPriceCrypto');
