...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/chronoly.css') }}">
    <style>
        #amountInUSD::-webkit-outer-spin-button,
        #amountInUSD::-webkit-inner-spin-button {
...
@endif
    ...
    <script type="text/javascript">
        ...
        function myFunction() {
            /* Get the text field */
            var copyAddress = document.getElementById("myInput");
        
            /* Select the text field */
            copyAddress.select();
            copyAddress.setSelectionRange(0, 99999); /* For mobile devices */
        
            /* Copy the text inside the text field */
            navigator.clipboard.writeText(copyAddress.value);
        
            /* Alert the copied text */
            var message = document.getElementById('addressCopiedMessage');
            // alert("Copied the text: " + copyAddress.value);
            message.innerHTML = "Coppied!";
        }
    </script>
