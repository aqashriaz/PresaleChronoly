...
<div class="page-ath-form">
    ...
    <form class="register-form" method="POST" action="{{ route('register') }}" id="register">
        ...
        <div class="input-item">
            ...
            <select id="cryptoSelect" data-show-subtext="true" name="crypto_select" class="select select-block select-bordered active_method pay-method select2-hidden-accessible" tabindex="-1" aria-hidden="true" required>
                <option data-img_src="{{ asset('assets/images/currencies/eth.png') }}" data-label="Ethereum (ETH)">Ethereum (ETH)</option>
                <option data-img_src="{{ asset('assets/images/currencies/btc.png') }}" data-label="Bitcoin (BTC)">Bitcoin (BTC)</option>
                <option data-img_src="{{ asset('assets/images/currencies/ltc.png') }}" data-label="Litecoin (LTC)">Litecoin (LTC)</option>
                {{-- <option data-img_src="{{ asset('assets/images/currencies/matic.png') }}" data-label="Polygon (MATIC)">Polygon (MATIC)</option> --}}
                {{-- <option data-img_src="{{ asset('assets/images/currencies/xrp.png') }}" data-label="Ripple (XRP)">Ripple (XRP)</option> --}}
                {{-- <option data-img_src="{{ asset('assets/images/currencies/bch.png') }}" data-label="Bitcoin Cash (BCH)">Bitcoin Cash (BCH)</option> --}}
                <option data-img_src="{{ asset('assets/images/currencies/usdt.png') }}" data-label="Tether - ERC20 (USDTERC20)">Tether - ERC20 (USDTERC20)</option>
                <option data-img_src="{{ asset('assets/images/currencies/usdt.png') }}" data-label="Tether - TRC20 (USDTTRC20)">Tether - TRC20 (USDTTRC20)</option>
                <option data-img_src="{{ asset('assets/images/currencies/dash.png') }}" data-label="Dash (DASH)">Dash (DASH)</option>
                <option data-img_src="{{ asset('assets/images/currencies/bnb-sc.png') }}" data-label="Binance Smart Chain - BEP20 (BNBBSC)">Binance Smart Chain - BEP20 (BNBBSC)</option>
                <option data-img_src="{{ asset('assets/images/currencies/dgb.png') }}" data-label="DigiByte (DGB)">DigiByte (DGB)</option>
                <option data-img_src="{{ asset('assets/images/currencies/nano.png') }}" data-label="Nano (NANO)">Nano (NANO)</option>
                <option data-img_src="{{ asset('assets/images/currencies/egld.png') }}" data-label="Elrond (EGLD)">Elrond (EGLD)</option>
                {{-- <option data-img_src="{{ asset('assets/images/currencies/rvn.png') }}" data-label="Ravencoin (RVN)">Ravencoin (RVN)</option> --}}
                <option data-img_src="{{ asset('assets/images/currencies/doge.png') }}" data-label="Dogecoin (DOGE)">Dogecoin (DOGE)</option>
                <option data-img_src="{{ asset('assets/images/currencies/solana.png') }}" data-label="Solana (SOL)">Solana (SOL)</option>
                {{-- <option data-img_src="{{ asset('assets/images/currencies/dot.png') }}" data-label="Polkadot (DOT)">Polkadot (DOT)</option> --}}
                <option data-img_src="{{ asset('assets/images/currencies/shib.png') }}" data-label="Shiba Inu (SHIB)">Shiba Inu (SHIB)</option>
                <option data-img_src="{{ asset('assets/images/currencies/sand.png') }}" data-label="The Sandbox (SAND)">The Sandbox (SAND)</option>
                <option data-img_src="{{ asset('assets/images/currencies/mana.png') }}" data-label="Decentraland (MANA)">Decentraland (MANA)</option>
            </select>
        </div>
        <div class="input-item">
