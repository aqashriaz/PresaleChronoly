    ...
    <div class="modal-dialog modal-dialog-md modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="popup-body popup-body-md">
                ...
                <p>{!!__('In order to receive your CRNO token, please add your wallet address below. You will receive your CRNO tokens to this wallet address, once the presale ends.') !!}</p>
