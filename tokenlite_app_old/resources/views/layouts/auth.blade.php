...
@endif
    ...
    <script>
        ...
        window.intlTelInput(input, {
          ...
          utilsScript: "https://presale.firepin.io/assets/js/intl-tel-input-utils.js?ver=20211030132",
        ...
        // Crypto selectbox images
        function custom_template(obj){
                var data = $(obj.element).data();
                var text = $(obj.element).text();
                if(data && data['img_src']){
                    img_src = data['img_src'];
                    template = $("<img src=\"" + img_src + "\" style=\"width:24px;height:24px;\"/><span style=\"margin-left:10px;\">" + text + "</span>");
                    return template;
                }
            }
        var options = {
