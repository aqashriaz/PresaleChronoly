        ...
        <form action="{{ route('user.payments') }}" method="post" class="token-purchase">
            ...
            <div class="token-contribute">
                ...
                <div class="token-calc">
                    <div class="token-pay-amount payment-get"><input class="input-bordered input-with-hint" required name="usdAm" type="text" id="amountInUSD" value="{{ $preferredAmount }}" min="10" autocomplete="off" ><div class="token-pay-currency"><span class="input-hint input-hint-sap payment-get-cur payment-cal-cur ucap">{{ $bc }}</span></div></div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function(event) { 
        ...
        // var totalCryptoPayment = document.getElementById('totalCrypto');
        // totalCryptoPayment.addEventListener('DOMSubtreeModified', myFunction);
        // function myFunction(e) {
        //     document.getElementById('total_tokens_price').value = totalCryptoPayment.innerHTML;
        // }

        // var totalBonus = document.getElementById('totalBonusGet');
        // totalBonus.addEventListener('DOMSubtreeModified', totalBonusFunction);
        // function totalBonusFunction(e) {
        //     //console.log(totalBonus.innerHTML);
        //     document.getElementById('totalBonus').value = totalBonus.innerHTML;
        // }

        // var totalCryptoNum = document.getElementById('total-tokens-amount');
        // totalCryptoNum.addEventListener('DOMSubtreeModified', numFunction);
        // function numFunction(e) {
        //     document.getElementById('total_tokens_num').value = totalCryptoNum.innerHTML;
        // }
        ...
        // $("#token-number").on("change", updateUSD);
        // function updateUSD()
        // {
        //     var usd = $("#token-number").val();
        //     var crno = $("#totalUSD");
        //     crno.html(usd/100);
        ...
        $("#amountInUSD").on("keyup", updatePrc);
