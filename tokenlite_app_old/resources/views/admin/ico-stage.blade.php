                        ...
                        <div class="stage-item stage-card {{(gws('actived_stage') == $stage->id)?'stage-item-actived':'' }}">
                            ...
                            <div class="stage-date">
                                <div class="row">
                                    <div class="col-6">
                                        <h6>Start Date</h6>
                                        <h5>{{ _date($stage->start_date, gws('site_date_format')) }} <br><small>{{ _date($stage->start_date, gws('site_time_format')) }}</small></h5>
                                    </div>
                                    <div class="col-6">
                                        <h6>End Date</h6>
                                        <h5>{{ _date($stage->end_date, gws('site_date_format')) }} <br><small>{{ _date($stage->end_date, gws('site_time_format')) }}</small></h5>
                                    </div>
                                </div>
                            </div>
                        </div>{{-- .stage-card --}}
