...
<div class="page-ath-form">
    ...
    <form class="register-form" method="POST" action="{{ route('register') }}" id="register">
        ...
        <div class="input-item">
            <select name="crypto_select" class="select select-block select-bordered active_method pay-method select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                <option data-label="Ethereum (ETH)">ETH</option>
                <option data-label="Bitcoin (BTC)">BTC</option>
                <option data-label="Litecoin (LTC)">LTC</option>
                <option data-label="Ripple (XRP)">XRP</option>
                <option data-label="Bitcoin Cash (BCH)">BCH</option>
                <option data-label="Tether - ERC20 (USDTERC20)">USDTERC20</option>
                <option data-label="Tether - TRC20 (USDTTRC20)">USDTTRC20</option>
                <option data-label="Dash (DASH)">DASH</option>
                <option data-label="Binance Smart Chain - BEP20 (BNBBSC)">BNBBSC</option>
                <option data-label="DigiByte (DGB)">DGB</option>
                <option data-label="Nano (NANO)">NANO</option>
                <option data-label="Elrond (EGLD)">EGLD</option>
                <option data-label="Ravencoin (RVN)">RVN</option>
                <option data-label="Dogecoin (DOGE)">DOGE</option>
                <option data-label="Solana (SOL)">SOL</option>
                <option data-label="Polkadot (DOT)">DOT</option>
                <option data-label="Shiba Inu (SHIB)">SHIB</option>
                <option data-label="The Sandbox (SAND)">SAND</option>
                <option data-label="Decentraland (MANA)">MANA</option>
            </select>
        </div>
        <div class="input-item">
